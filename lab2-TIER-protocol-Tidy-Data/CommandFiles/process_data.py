...
# clean output directory - we want only files generated by this script
...
# decision: we drop the couple of rows containing NaN fields
selected_data = renamed_data[selected_columns].dropna()
